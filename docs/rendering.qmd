...
For a form-based notebook workflow, install the optional UI extra and call
`load()` in a cell:
...
The widget exposes the `new_review()` fields, a **Generate image** button, and
buttons to save SVG or PNG files.
