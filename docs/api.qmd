...
| Method | Description |
|---|---|
| `PrismaFlow(...)` | Create a v0.1 new-review flow from flat count arguments or nested stage models. |
| `PrismaFlow.new_review(...)` | Explicit factory for a v0.1 new-review flow from flat count arguments. |
