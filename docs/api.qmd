...
The core public API is exported from `prismaflow`. Optional notebook widgets are
exported from `prismaflow.ui`.
...
- `prismaflow.ui.load(...)`: create an interactive Jupyter widget for the
  `new_review()` parameters, inline SVG preview, and SVG/PNG save buttons.
